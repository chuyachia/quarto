var Game = function(){
    ...
    var lastPosition = '';
    var placed = Array.apply(null, Array(4)).map(function(){return [0,0,0,0]});
    var cylinder = Array.apply(null, Array(4)).map(function(){return [0,0,0,0]});
    var hole = Array.apply(null, Array(4)).map(function(){return [0,0,0,0]});
    var dark = Array.apply(null, Array(4)).map(function(){return [0,0,0,0]});
    var short = Array.apply(null, Array(4)).map(function(){return [0,0,0,0]});
